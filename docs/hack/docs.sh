...
sphinx-apidoc -f -e -o docs/source/apidoc/ nlp_test_neoway/
...
sed -i.bak '0,/nlp_test_neoway/s//API/' docs/source/apidoc/modules.rst
# Show package's name in the home page
sed -i.bak '0,/project/s//nlp_test_neoway/' docs/source/index.rst
# Delete backup files
